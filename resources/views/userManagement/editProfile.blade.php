          ...
          <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
            <div class="card z-index-0">
              ...
              <div class="card-body">
                ...
                <img class="rounded-circle mt-5" height="250" width="250" src="@if($image == null) {{ asset("storage/profile_images/avatar.png") }}  @else {{ asset("storage/$image") }} @endif" id="image_preview_container">
                <span class="font-weight-bold">
                    <input type="file" name="image" id="image"  class="form-control">
                </span>
            </div>
                  <div class="mb-3">
                    <input id="inputName" type="text" class="form-control" name="name" placeholder="Name" aria-label="Name" value="{{ $user->name}}" required autocomplete="name" aria-describedby="email-addon">
                  <!--  @error('name')
                  ...
                  <div class="mb-3">
                    <input id="inputEmail" readonly type="email" class="form-control" name="email" placeholder="Email" aria-label="Email" value="{{ $user->email}}" required autocomplete="email" aria-describedby="email-addon">
                   <!-- @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                  ...
                  <div class="mb-3">
                    <input type="number" class="form-control" name="tel" placeholder="Telephone" aria-label="Telephone" value="{{ $user->tel}}" required autocomplete="tel" aria-describedby="email-addon">
                    <!-- @error('tel')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                  ...
                  <div class="mb-3">
                    <input type="text" class="form-control" name="ville" placeholder="Ville" aria-label="Ville" value="{{ $user->ville}}" required autocomplete="ville" aria-describedby="email-addon">
                  <!--  @error('ville')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                  ...
                  <div class="text-center">
                    <button type="submit"  value="Modify" class="btn bg-gradient-dark w-100 my-4 mb-2"></button>
                  </div>
