...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <form action="{{ route('traitement.compte') }}" method="post">
    @csrf
    <label for="visa">Compte Visa:</label>
    <input type="text" name="visa" id="visa">

    <label for="mastercard">Compte Mastercard:</label>
    ...
    <div id="maDiv">
  <video id="maVideo" src="assets/img/paiement.mp4" autoplay muted loop>
  </video>
</div>
                            ...
                            <div class="row">
                                <div class="col-lg-10">
                                    <div class="checkout__input">
                                        <p>nom->client<span>*</span></p>
                                        <input type="text">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="checkout__input">
                                        <p>Entrez le numero de la carte qui vous correspond<span>*</span></p>
                                        <div class="input-with-image">
                                        <input type="number" name="numero_compte">
                                        
                                        <img src="assets/img/logos/mastercard.png" alt="Image">
                                        </div>
                                        <div class="emplacement-input">

                                        <div class="input-with-image">
                                        <input type="number" name="numero_compte">
                                        
                                        <img src="assets/img/logos/visa.png" alt="Image">
                                        </div>
                                        </div>
