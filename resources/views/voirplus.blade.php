...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
        <img src="../assets/img/logosite.png" height="500" width="100" class="navbar-brand-img h-100" alt="main_logo">  <img src="../assets/img/autobus.png" height="40" width="40" class="navbar-brand-img h-100" >
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">check out</h6>
        </nav>
    ...
    <div class="row gx-9">
      <div class="col-auto">
        <div class="avatar avatar-xl position-relative">
          <img src="../assets/img/logosite.png" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
        </div>
      </div>
...
<div class="info-div">
  <video id="maVideo" src="assets/img/info1.mp4" autoplay muted loop> 
</div>
<style>
  #maVideo {
    width: 555px; 
    ...
    <div class="container-fluid py-4">
      ...
      <div class="row mt-1">
        <div class="col-lg-8 mb-lg-100 mb-20">
          <div class="card">
        ...
        <div class="container">
                ...
                <form action="#">
                    <div class="row">
                        <div class="col-lg-10 col-md-10">
                            ...
                            <h6 class="checkout__title">Entrez Vos Informations pour confirmer votre abonnement</h6>
                            <div class="row">
                                <div class="col-lg-10">
          ...
          <div class="card h-100 p-3">
            ...
            <div class="checkout__order">
                                <h4 class="order__title">L'offre choisie</h4>
                                <div class="checkout_order_products"> <span></span></div>
                                <ul class="checkout_total_products">
                                    <li> L'entreprise : Ghazala Voyageur <span></span></li>
                                    <li> L'offre : 1 <span></span></li>
                                    <li> Type : abonnement navette etudiant <span></span></li>
                                    <li> "lieu depart" et "lieu arrive" <span></span></li>
                                    <li> Durée : 1mois" <span></span></li>
                                </ul>
                                <ul class="checkout_total_all">
                                    <li>Subtotal <span>199.00DHS</span></li>
                                    <li>Total <span>199.00DHS</span></li>
                                </ul>
                                ...
                                <button type="submit" class="site-btn">Cliquez ici</button>
                            </div>
                        </div>
