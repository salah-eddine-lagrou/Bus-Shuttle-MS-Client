...
<div class="container-fluid">
      <div class="page-header min-height-100 border-radius-xl mt-1" style="background-image: url('../assets/img/curved-images/curved0.jpg'); background-position-y: 50%;">
        <span class="mask bg-gradient-primary opacity-6"></span>
      </div>
      <div class="card card-body blur shadow-blur mx-5 mt-n6 overflow-hidden">
        <div class="row gx-4">
          <div class="col-auto">
              ...
              <div class="row">
                  ...
                  <div class="card card-blog card-plain">
                    <div class="position-relative">
                      <a class="d-block shadow-xl border-radius-xl">
                        <img src="../assets/img/offre1.png" alt="img-blur-shadow" class="img-fluid shadow border-radius-xl">
                      </a>
                    </div>
                    <div class="card-body px-1 pb-0">
                      <p class="text-gradient text-dark mb-2 text-sm">Offre 1</p>
                      <a href="javascript:;">
                        <h5>
                          Entreprise Ghazala
                        </h5>
                      ...
                      <p class="mb-4 text-sm">
                               Navettez à petit prix chez Ghazala transport    </p>
                      <p id="unique">L'offre terminera à """"</p>
                                <style>
                                        p[id="unique"] {
                    ...
                    <div class="col-3 text-end">
                      <a class="btn bg-gradient-dark mb-1">&nbsp;&nbsp;199MAD/Mois</a>
                    </div>

                      <div class="d-flex align-items-center justify-content-between">
                        <div class="voirplushome">
                        <button type="button" class="btn btn-outline-primary btn-sm mb-9">Voir Plus</button>
                ...
                <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
                  <div class="card card-blog card-plain">
                    <div class="position-relative">
                      <a class="d-block shadow-xl border-radius-xl">
                        <img src="../assets/img/offre1.png" alt="img-blur-shadow" class="img-fluid shadow border-radius-lg">
                      </a>
                    </div>
                    <div class="card-body px-1 pb-0">
                  ...
                  <div class="card h-100 card-plain border">
                    <div class="card-body d-flex flex-column justify-content-center text-center">
                      <a href="javascript:;">
                        ...
                        <h5 class=" text-secondary"> View more projects </h5>
                      </a>
                    </div>
                  </div>
                </div>
