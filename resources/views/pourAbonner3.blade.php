...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{ route('page/client/profile') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            Profile<a href="{{ route('page/client/profile') }}">
    <span></span>
</a>
          </a>
        </li>
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <li class="breadcrumb-item text-sm"><a class="opacity-6 text-dark" href="#">Acceuil</a></li>
            <li class="breadcrumb-item text-sm text-dark active"><a class="opacity-6 text-dark" href="#">Offres</a></li>
            <li class="breadcrumb-item text-sm text-dark active" ><a class="opacity-6 text-dark" href="#">Voir Plus</a></li>
            <li class="breadcrumb-item text-sm text-dark active" ><a class="opacity-6 text-dark" href="#">CheckOut</a></li>
            <li class="breadcrumb-item text-sm text-dark active" ><a class="opacity-6 text-dark" href="#">Vérification des informations</a></li>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Acceuil</p>
                ...
                <div class="col-4 text-end">
                    <div>
                    <a href="www.google.com"><i class="icon icon-shape bg-gradient-primary shadow text-center border-radius-md">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Votre Profile</p>
                    <h5 class="font-weight-bolder mb-0">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Retour aux Offres</p>
                    <h5 class="font-weight-bolder mb-0">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Déconnexion</p>
                    <h5 class="font-weight-bolder mb-0">
                ...
                <table class="table align-items-center justify-content-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Montant A payer</th>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          <div>
                            <img src="../assets/img/offre1.png" class="avatar avatar-sm rounded-circle me-2" alt="spotify">
                          </div>
                          <div class="my-auto">
                            <h6 class="mb-0 text-sm">Ghazala Voyageur</h6>
                          </div>
                        </div>
                      </td>
                    
                      <td>
                        <span class="text-xs font-weight-bold">ouiamerehouni@gmail.com</span>
                      </td>
                      <td>
                        <span class="text-xs font-weight-bold">Ouiame Rehouni</span>
                      </td>
                      <td>
                        <p class="text-sm font-weight-bold mb-0">199.00DHS</p>
                      </td>
      ...
      <div class="row mt-2">
        ...
        <div class="container">
            <div class="checkout__form">
                <form action="#">
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <h6 class="checkout__title">Entrez Vos Informations concernant votre compte</h6>
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="checkout__input">
                                        <p>Numéro du compte<span>*</span></p>
                                        <input type="number">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="checkout__input">
                                        <p>Nom du compte<span>*</span></p>
                                        <input type="text">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="checkout__input">
                                <p>Type d'abonnement<span>*</span></p>
                ...
                <div class="col-lg-6">
                  <div class="d-flex flex-column h-5000"></p>
